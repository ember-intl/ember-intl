...
# Update fixtures (v8)
rm -r "tests/fixtures/v8/v1-addon/output"
cp -r "tests/fixtures/v8/v1-addon/input" "tests/fixtures/v8/v1-addon/output"

./dist/bin/ember-intl-update.js \
  --root "tests/fixtures/v8/v1-addon/output"

rm -r "tests/fixtures/v8/v1-app/output"
cp -r "tests/fixtures/v8/v1-app/input" "tests/fixtures/v8/v1-app/output"

./dist/bin/ember-intl-update.js \
  --root "tests/fixtures/v8/v1-app/output"

rm -r "tests/fixtures/v8/v2-addon/output"
cp -r "tests/fixtures/v8/v2-addon/input" "tests/fixtures/v8/v2-addon/output"

./dist/bin/ember-intl-update.js \
  --root "tests/fixtures/v8/v2-addon/output"

rm -r "tests/fixtures/v8/v2-app/output"
cp -r "tests/fixtures/v8/v2-app/input" "tests/fixtures/v8/v2-app/output"

./dist/bin/ember-intl-update.js \
  --root "tests/fixtures/v8/v2-app/output"
