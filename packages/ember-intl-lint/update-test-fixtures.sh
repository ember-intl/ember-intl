...
# Update fixtures
rm -r "tests/fixtures/my-v2-app-fix-2/output"
cp -r "tests/fixtures/my-v2-app-fix-2/input" "tests/fixtures/my-v2-app-fix-2/output"

./dist/bin/ember-intl-lint.js \
  --fix \
  --root "tests/fixtures/my-v2-app-fix-2/output"
