...
import {
  inputProject,
  outputProject,
} from '../fixtures/my-v2-app-with-addonPaths/index.js';
import { codemodOptions } from '../helpers/shared-test-setups/my-v2-app-with-addonPaths.js';

test('index > my-v2-app-with-addonPaths', async function () {
