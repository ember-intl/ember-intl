...
import {
  inputProject,
  outputProject,
} from '../fixtures/my-v2-app-fix-2/index.js';
import { codemodOptions } from '../helpers/shared-test-setups/my-v2-app-fix-2.js';

test('index > my-v2-app-fix-2', async function () {
