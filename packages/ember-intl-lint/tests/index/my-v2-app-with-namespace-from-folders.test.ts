...
import {
  inputProject,
  outputProject,
} from '../fixtures/my-v2-app-with-namespace-from-folders/index.js';
import { codemodOptions } from '../helpers/shared-test-setups/my-v2-app-with-namespace-from-folders.js';

test('index > my-v2-app-with-namespace-from-folders', async function () {
