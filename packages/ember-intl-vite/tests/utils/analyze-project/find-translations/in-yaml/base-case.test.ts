...
test('utils | analyze-project | find-translations | in-yaml > base case', function () {
  const file = normalizeFile([
    ...
    `routes.application.copyright: 'Created by <a href="https://www.linkedin.com/in/ijlee2/" rel="noopener noreferrer" target="_blank">Isaac J. Lee</a> © 2025'`,
