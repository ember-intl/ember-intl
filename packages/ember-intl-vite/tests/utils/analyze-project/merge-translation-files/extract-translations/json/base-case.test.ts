...
test('utils | analyze-project | merge-translation-files | extract-translations | json > base case', function () {
  const file = JSON.stringify({
    ...
    'routes.application.navigation-menu': null,
    'routes.application.navigation-menu.name': 'Main Navigation',
    'routes.application.navigation-menu.routes': null,
    ...
    'routes.form.contact-me-form.fields.message.placeholder': null,
    ...
    'routes.form.contact-me-form.fields.subscribe.placeholder': null,
