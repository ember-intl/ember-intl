  ...
  <template>
    ...
    <section>
      ...
      <div data-test-field="Format Number">
        {{formatNumber 1000 currency="EUR" format="currency" style="currency"}}
      </div>
    </section>
    ...
    <section>
      ...
      <div data-test-field="Format Date">
        {{formatDate "Thu Jan 23 2014 18:00:44 GMT+0000 (GMT)" timeZone="UTC"}}
      </div>
    </section>
    ...
    <section>
      ...
      <div data-test-field="Format Date Range">
        {{formatDateRange 1390500044000 1390759244000 timeZone="UTC"}}
      </div>
    </section>
