...
- [#1911](https://github.com/ember-intl/ember-intl/pull/1911) Create a docs-app that checks publicOnly: true on the classic build ([@ijlee2](https://github.com/ijlee2))
