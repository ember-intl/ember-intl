...
import TranslationWithArguments from 'my-v1-classic-app/components/translation-with-arguments';
import type IndexController from 'my-v1-classic-app/controllers/index';
