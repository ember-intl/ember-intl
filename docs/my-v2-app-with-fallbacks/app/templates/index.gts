...
import ComponentFromApp from 'my-v2-app-with-fallbacks/components/component-from-app';
import TranslationWithArguments from 'my-v2-app-with-fallbacks/components/translation-with-arguments';
