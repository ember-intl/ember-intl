...
> [!TIP]
>
> Run `pnpx @ember-intl/update` to address breaking changes. The badge `Supported by codemod` appears next to those that the codemod can handle.
...
### Removed `app/formats.js` <Badge text="Supported by codemod" type="tip" /> {#breaking-changes-removed-app-formats-js}
...
### Removed build options <Badge text="Supported by codemod" type="tip" /> {#breaking-changes-removed-build-options}
...
### Removed linting of translations <Badge text="Supported by codemod" type="tip" /> {#breaking-changes-removed-linting-of-translations}
...
### Removed loading of translations <Badge text="Supported by codemod" type="tip" /> {#breaking-changes-removed-loading-of-translations}
