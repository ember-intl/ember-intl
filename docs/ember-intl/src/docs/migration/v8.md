...
Install `v1` of `@ember-intl/lint`, `@ember-intl/v1-compat`, and `@ember-intl/vite` to guarantee their compatibility with `ember-intl@v8`.
...
### Removed `app/formats.js` <Badge text="Run codemod" /> {#breaking-changes-removed-app-formats-js}
...
### Removed build options <Badge text="Run codemod" /> {#breaking-changes-removed-build-options}
...
### Removed linting of translations <Badge text="Run codemod" /> {#breaking-changes-removed-linting-of-translations}
...
### Removed loading of translations <Badge text="Run codemod" /> {#breaking-changes-removed-loading-of-translations}
...
### Renamed `formatRelative` <Badge text="Run codemod" /> {#breaking-changes-renamed-format-relative}
...
### Simplified message for `setOnMissingTranslation` in tests <Badge text="Run codemod" /> {#breaking-changes-simplified-message-for-set-on-missing-translation-in-tests}
...
>
> For more information, see subsections titled "v1 apps" in [Quickstart (Apps)](../quickstart). You can also check [`@ember-intl/v1-compat`'s `README`](https://github.com/ember-intl/ember-intl/blob/main/packages/ember-intl-v1-compat/README.md).
...
>
> For more information, see subsections titled "v2 apps" in [Quickstart (Apps)](../quickstart). You can also check [`@ember-intl/vite`'s `README`](https://github.com/ember-intl/ember-intl/blob/main/packages/ember-intl-vite/README.md).
