...
If you have a new project, you will need to create these files manually. If you want to override the build options, see [Customizing loading of translations](../advanced/customizing-loading-of-translations).
...
The `ember-intl` package is no longer responsible for linting translations. For migration, see [`@ember-intl/lint`](#-ember-intl-lint) below.


### Removed loading of translations

The `ember-intl` package is no longer responsible for loading and merging translations. For migration, see [`@ember-intl/v1-compat`](#-ember-intl-v1-compat) or [`@ember-intl/vite`](#-ember-intl-vite) below.
...
It delegates linting to [`@ember-intl/lint`](#-ember-intl-lint), and loading and merging translations to [`@ember-intl/v1-compat`](#-ember-intl-v1-compat) and [`@ember-intl/vite`](#-ember-intl-vite). Therefore, when you update `ember-intl` to `v8`, you may want to install these packages as development dependencies.
